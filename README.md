...
This project investigates the algebraic structure of powers of `(1 − ζₚ)`, where `ζₚ` is a primitive *p*-th root of unity and *p* is an odd prime. `(1 − ζₚ)`is a central object in algebraic number theory and *p*-adic analysis.
...
This Read Me file was generated by Copilot, with minor edit from Hoang Trieu. 
